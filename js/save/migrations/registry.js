(function initMLFSaveMigrationRegistry(root, factory) {
    ...
    if (typeof module !== 'undefined' && module.exports) {
        ...
        module.exports = factory(migrationV0ToV1);
        return;
    }
    root.MLFSaveMigrationRegistry = factory(root.MLFSaveMigrationV0ToV1);
})(typeof globalThis !== 'undefined' ? globalThis : window, function createMLFSaveMigrationRegistry(migrationV0ToV1) {
    'use strict';
