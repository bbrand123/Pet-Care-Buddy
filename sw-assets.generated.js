...
self.SW_GENERATED_ASSETS = Object.freeze([
  ...
  "./js/content-packs.js",
  "./js/core.js",
  "./js/core/bootstrap-coordinator.js",
  "./js/core/device-feedback-service.js",
  "./js/core/persistence-coordinator.js",
  "./js/core/visibility-resume-coordinator.js",
  ...
  "./js/data/rooms.js",
  "./js/decay.js",
  "./js/diagnostics/diagnostics-ui.js",
  "./js/diagnostics/error-buffer.js",
  ...
  "./js/rooms.js",
  "./js/save/lifecycle-bridge.js",
  "./js/save/migrate.js",
  "./js/save/migrations/registry.js",
  "./js/save/migrations/v0-to-v1.js",
  "./js/save/migrations/v1-to-v2.js",
  "./js/save/migrations/v2-to-v3.js",
  "./js/save/migrations/v3-to-v4.js",
  "./js/save/offline-progression-config.js",
  "./js/save/offline-progression.js",
  ...
  "./js/state.js",
  "./js/state/canonical-state.js",
  "./js/state/household-state.js",
  "./js/state/migrations.js",
  "./js/state/state-domain-bridges.js",
  "./js/svg.js",
  "./js/ui/actions.js",
  "./js/ui/animations.js",
  "./js/ui/breeding.js",
